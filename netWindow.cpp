...
void netWindow::tcpServerDataReceived(char *msg,int length,int socketDescriptorEx)
{
...
void netWindow::on_bt_detect_net_clicked()
{
...
void netWindow::on_bt_task_begin_clicked()
{
    if(_is_tasking==1){
...
void netWindow::tcpClientDataReceived(){
...
void netWindow::merge_packet(int uuid, int data_size)
{
...
//    }
    ...
    MainWindow *parent = (MainWindow*)_parent;
    parent->add_sync_database(str);
}


void netWindow::on_bt_stop_task_clicked()
{
   _is_tasking = 0;
}
